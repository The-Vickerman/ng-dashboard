...
const LAST_REFRESHED = "August 7, 2026 · 11:50 AM CT";
const AS_OF     = "August 7, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians as of Jul 16 recompute (Jan 1, 2026+ closed-case census, null-reason excluded)";
const THIS_WEEK = "Aug 1–7";
const PREV_WEEK = "Jul 29–Aug 4";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:31,addon:55,update:19,all:109}, a30:{new:28,addon:54,update:16,all:99},
    a100:{new:24,addon:48,update:0,all:72}, cl7:{new:1,addon:2,update:2,all:7},
    cp7:{new:0,addon:2,update:0,all:2}, n7:{new:1,addon:0,update:3,all:5},
    np7:{new:0,addon:0,update:1,all:4}, openp7:111,
  ...
  { name:"Daisy Marquez", region:"Americas",
    ...
    a100:{new:11,addon:8,update:21,all:48}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:54,
  ...
  { name:"Jevon Jackson", region:"Americas",
    open:{new:42,addon:30,update:12,all:88}, a30:{new:18,addon:19,update:12,all:52},
    a100:{new:13,addon:5,update:7,all:28}, cl7:{new:2,addon:0,update:2,all:4},
    cp7:{new:1,addon:0,update:0,all:1}, n7:{new:1,addon:2,update:0,all:4},
    np7:{new:0,addon:0,update:0,all:0}, openp7:88,
  ...
  { name:"Kristen Whitman", region:"Americas",
    ...
    a100:{new:0,addon:1,update:1,all:2}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:6,update:3,all:9}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:2,all:2}, openp7:9,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:37,addon:8,update:5,all:74}, a30:{new:36,addon:8,update:5,all:69},
    a100:{new:11,addon:3,update:0,all:24}, cl7:{new:6,addon:2,update:3,all:12},
    cp7:{new:1,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:0,update:0,all:0}, openp7:85,
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:{new:16,addon:13,update:21,all:55}, a30:{new:13,addon:7,update:5,all:30},
    a100:{new:2,addon:2,update:2,all:11}, cl7:{new:1,addon:1,update:1,all:3},
    cp7:{new:0,addon:1,update:0,all:1}, n7:{new:0,addon:0,update:3,all:3},
    np7:{new:0,addon:0,update:2,all:2}, openp7:55,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:30,update:26,all:71}, a30:{new:11,addon:27,update:21,all:60},
    a100:{new:3,addon:9,update:7,all:20}, cl7:{new:0,addon:0,update:1,all:2},
    cp7:{new:0,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:1,all:3},
    np7:{new:0,addon:0,update:3,all:3}, openp7:70,
  ...
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:8,addon:9,update:42,all:66}, a30:{new:5,addon:6,update:14,all:32},
    a100:{new:0,addon:0,update:0,all:0}, cl7:{new:0,addon:1,update:3,all:4},
    cp7:{new:0,addon:2,update:3,all:5}, n7:{new:0,addon:2,update:13,all:15},
    np7:{new:0,addon:0,update:4,all:4}, openp7:55,
  ...
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:11,addon:16,update:2,all:49}, a30:{new:9,addon:11,update:2,all:24},
    a100:{new:4,addon:1,update:0,all:5}, cl7:{new:3,addon:8,update:1,all:21},
    cp7:{new:2,addon:1,update:1,all:5}, n7:{new:0,addon:3,update:0,all:19},
    np7:{new:0,addon:3,update:0,all:20}, openp7:51,
    median:{new:45,addon:56,update:39,all:42}, medianAdj:{new:32,addon:52,update:15,all:33},
    medianTrend:[42,42,42,42,42] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:11,addon:19,update:16,all:52}, a30:{new:11,addon:19,update:16,all:52},
    a100:{new:9,addon:2,update:15,all:30}, cl7:{new:0,addon:2,update:0,all:2},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:54,
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:7,addon:12,update:1,all:36}, a30:{new:7,addon:12,update:1,all:26},
    a100:{new:5,addon:3,update:0,all:13}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:0,all:10},
