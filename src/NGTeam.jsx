...
const AS_OF     = "July 13, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians as of Jun 28";
const THIS_WEEK = "Jul 7–13";
const PREV_WEEK = "Jun 30–Jul 6";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:40,addon:67,update:34,all:144}, a30:{new:34,addon:64,update:13,all:112},
    a100:{new:1,addon:3,update:1,all:5}, cl7:{new:0,addon:0,update:4,all:4},
    cp7:{new:1,addon:3,update:4,all:8}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:3,addon:3,update:14,all:20}, openp7:148,
  ...
  { name:"Daisy Marquez", region:"Americas",
    open:{new:13,addon:9,update:21,all:53}, a30:{new:13,addon:9,update:21,all:53},
    a100:{new:10,addon:9,update:21,all:48}, cl7:{new:0,addon:0,update:0,all:0},
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    a100:{new:15,addon:6,update:5,all:29}, cl7:{new:0,addon:0,update:3,all:3},
    cp7:{new:0,addon:1,update:0,all:1}, n7:{new:0,addon:4,update:0,all:4},
    np7:{new:0,addon:4,update:0,all:4}, openp7:72,
  ...
  { name:"Kristen Whitman", region:"Americas",
    open:{new:5,addon:14,update:5,all:24}, a30:{new:4,addon:13,update:4,all:21},
    a100:{new:1,addon:3,update:2,all:6}, cl7:{new:2,addon:2,update:1,all:5},
    cp7:{new:2,addon:1,update:1,all:4}, n7:{new:1,addon:0,update:0,all:1},
    np7:{new:0,addon:1,update:1,all:2}, openp7:28,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:61,addon:10,update:9,all:99}, a30:{new:41,addon:9,update:7,all:68},
    a100:{new:6,addon:2,update:1,all:19}, cl7:{new:0,addon:1,update:0,all:1},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:1,addon:0,update:0,all:4},
    np7:{new:0,addon:0,update:0,all:4}, openp7:96,
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:{new:15,addon:10,update:14,all:45}, a30:{new:11,addon:8,update:14,all:39},
    a100:{new:3,addon:3,update:0,all:6}, cl7:{new:0,addon:0,update:0,all:0},
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:24,update:26,all:69}, a30:{new:12,addon:22,update:20,all:57},
    a100:{new:2,addon:2,update:6,all:11}, cl7:{new:0,addon:2,update:3,all:5},
    cp7:{new:0,addon:2,update:1,all:3}, n7:{new:0,addon:1,update:1,all:5},
    np7:{new:1,addon:1,update:2,all:4}, openp7:69,
  ...
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:8,addon:9,update:13,all:38}, a30:{new:6,addon:8,update:6,all:21},
    a100:{new:0,addon:2,update:0,all:2}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:2,all:2}, n7:{new:0,addon:0,update:1,all:1},
    np7:{new:0,addon:0,update:0,all:0}, openp7:38,
  ...
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:15,addon:13,update:4,all:42}, a30:{new:13,addon:12,update:3,all:37},
    a100:{new:8,addon:8,update:0,all:25}, cl7:{new:1,addon:1,update:3,all:10},
  ...
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:10,addon:26,update:16,all:60}, a30:{new:10,addon:24,update:15,all:56},
    a100:{new:7,addon:2,update:12,all:25}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:1}, openp7:60,
