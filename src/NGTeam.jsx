...
const AS_OF     = "August 14, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians reverted to the Jul 16 full-census baseline (Jan 1 2026+, null-reason excluded) after a brief methodology inconsistency — full clean recompute in progress";
