...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:31,addon:54,update:19,all:106}, a30:{new:30,addon:52,update:11,all:94},
    a100:{new:24,addon:47,update:0,all:71}, cl7:{new:0,addon:1,update:4,all:5},
    cp7:{new:0,addon:0,update:4,all:6}, n7:{new:0,addon:0,update:6,all:6},
    np7:{new:0,addon:0,update:1,all:1}, openp7:105,
    median:{new:67,addon:62,update:24,all:34}, medianAdj:{new:46,addon:34,update:23,all:29},
    medianTrend:[32,32,34,34,34] },
  { name:"Daisy Marquez", region:"Americas",
    open:{new:14,addon:8,update:21,all:52}, a30:{new:14,addon:8,update:21,all:52},
  ...
  { name:"Kristina Quirouette", region:"Americas",
    ...
    a100:{new:15,addon:3,update:1,all:29}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:1,addon:0,update:2,all:3}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:1}, openp7:69,
    median:{new:89,addon:58,update:53,all:68}, medianAdj:{new:89,addon:35,update:53,all:63},
    medianTrend:[62,62,68,68,68] },
  { name:"Mariana Freitas", region:"Americas",
    open:{new:19,addon:16,update:26,all:66}, a30:{new:17,addon:11,update:12,all:45},
  ...
  { name:"Oleksii Kosenko", region:"EU",
    ...
    a100:{new:9,addon:1,update:15,all:28}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:3,update:0,all:6}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:2}, openp7:45,
    median:{new:160,addon:65,update:1,all:72}, medianAdj:{new:109,addon:54,update:1,all:62},
    medianTrend:[76,76,72,72,72] },
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:7,addon:14,update:1,all:40}, a30:{new:7,addon:14,update:1,all:28},
