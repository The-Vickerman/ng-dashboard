...
const LAST_REFRESHED = "August 4, 2026 · 11:35 AM CT";
const AS_OF     = "August 4, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians as of Jul 16 recompute (Jan 1, 2026+ closed-case census, null-reason excluded). Note: open-count accuracy for at least one analyst (Kristina) is under active investigation — a live discrepancy vs. her own count was found and hasn't been root-caused yet.";
const THIS_WEEK = "Jul 29–Aug 4";
const PREV_WEEK = "Jul 25–31";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:31,addon:56,update:19,all:112}, a30:{new:28,addon:55,update:17,all:101},
    a100:{new:24,addon:48,update:1,all:73}, cl7:{new:0,addon:2,update:0,all:2},
    cp7:{new:0,addon:2,update:0,all:2}, n7:{new:0,addon:0,update:1,all:4},
    np7:{new:0,addon:0,update:1,all:4}, openp7:110,
    median:{new:76,addon:62,update:22,all:32}, medianAdj:{new:40,addon:34,update:22,all:27},
    medianTrend:[26,32,32,32,32] },
  { name:"Daisy Marquez", region:"Americas",
    open:{new:15,addon:8,update:21,all:53}, a30:{new:15,addon:8,update:21,all:53},
    a100:{new:11,addon:8,update:21,all:48}, cl7:{new:0,addon:0,update:0,all:0},
  ...
  { name:"Jevon Jackson", region:"Americas",
    open:{new:41,addon:28,update:13,all:85}, a30:{new:17,addon:15,update:13,all:48},
    a100:{new:13,addon:4,update:7,all:27}, cl7:{new:1,addon:0,update:0,all:1},
    cp7:{new:1,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:86,
    median:{new:43,addon:48,update:41,all:42}, medianAdj:{new:28,addon:33,update:29,all:29},
    medianTrend:[74,42,42,42,42] },
  { name:"Kristen Whitman", region:"Americas",
    open:{new:3,addon:3,update:3,all:9}, a30:{new:2,addon:3,update:2,all:7},
    a100:{new:0,addon:1,update:1,all:2}, cl7:{new:0,addon:6,update:3,all:9},
    cp7:{new:0,addon:6,update:3,all:9}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:0,addon:0,update:2,all:2}, openp7:16,
    median:{new:42,addon:45,update:17,all:42}, medianAdj:{new:28,addon:45,update:17,all:28},
    medianTrend:[328,42,42,42,42] },
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:37,addon:8,update:6,all:72}, a30:{new:36,addon:8,update:5,all:67},
    a100:{new:11,addon:3,update:0,all:24}, cl7:{new:1,addon:0,update:0,all:1},
    cp7:{new:1,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:73,
    median:{new:63,addon:58,update:50,all:62}, medianAdj:{new:63,addon:28,update:50,all:56},
    medianTrend:[91,62,62,62,62] },
  { name:"Mariana Freitas", region:"Americas",
    open:{new:17,addon:12,update:23,all:57}, a30:{new:14,addon:6,update:9,all:34},
    a100:{new:3,addon:2,update:4,all:14}, cl7:{new:0,addon:1,update:0,all:1},
    cp7:{new:0,addon:1,update:0,all:1}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:0,addon:0,update:2,all:2}, openp7:56,
    median:{new:50,addon:44,update:32,all:40}, medianAdj:{new:34,addon:35,update:31,all:34},
    medianTrend:[66,40,40,40,40] },
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:31,update:28,all:73}, a30:{new:11,addon:28,update:22,all:62},
    a100:{new:2,addon:10,update:7,all:20}, cl7:{new:0,addon:0,update:0,all:1},
    cp7:{new:0,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:3,all:3},
    np7:{new:0,addon:0,update:3,all:3}, openp7:71,
    median:{new:84,addon:61,update:26,all:47}, medianAdj:{new:80,addon:43,update:24,all:28},
    medianTrend:[null,47,47,47,47] },
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:10,addon:8,update:34,all:59}, a30:{new:6,addon:6,update:11,all:30},
    a100:{new:0,addon:0,update:0,all:0}, cl7:{new:0,addon:2,update:3,all:5},
    cp7:{new:0,addon:2,update:3,all:5}, n7:{new:0,addon:0,update:4,all:4},
    np7:{new:0,addon:0,update:4,all:4}, openp7:60,
    median:{new:35,addon:0,update:31,all:34}, medianAdj:{new:15,addon:0,update:28,all:28},
    medianTrend:[32,34,34,34,34] },
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:12,addon:16,update:2,all:50}, a30:{new:10,addon:11,update:2,all:25},
    a100:{new:5,addon:1,update:0,all:6}, cl7:{new:2,addon:1,update:1,all:5},
    cp7:{new:2,addon:1,update:1,all:5}, n7:{new:0,addon:3,update:0,all:20},
    np7:{new:0,addon:3,update:0,all:20}, openp7:35,
    median:{new:45,addon:56,update:39,all:42}, medianAdj:{new:32,addon:52,update:15,all:33},
    medianTrend:[null,42,42,42,42] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:11,addon:20,update:16,all:53}, a30:{new:11,addon:20,update:16,all:53},
    a100:{new:9,addon:2,update:14,all:29}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:53,
    median:{new:160,addon:31,update:1,all:76}, medianAdj:{new:109,addon:30,update:1,all:60},
    medianTrend:[138,76,76,76,76] },
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:7,addon:12,update:1,all:32}, a30:{new:7,addon:12,update:1,all:26},
    a100:{new:5,addon:3,update:0,all:13}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:0,all:6},
    np7:{new:0,addon:0,update:0,all:6}, openp7:27,
    median:{new:0,addon:99,update:0,all:99}, medianAdj:{new:0,addon:84,update:0,all:84},
    medianTrend:[null,99,99,99,99] },
];
