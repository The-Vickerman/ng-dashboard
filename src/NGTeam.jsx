...
const LAST_REFRESHED = "August 12, 2026 · 7:30 AM CT";
const AS_OF     = "August 12, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians as of Jul 16 recompute (Jan 1, 2026+ closed-case census, null-reason excluded)";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:31,addon:55,update:15,all:103}, a30:{new:30,addon:55,update:12,all:98},
    a100:{new:24,addon:48,update:0,all:72}, cl7:{new:1,addon:1,update:4,all:9},
    cp7:{new:1,addon:0,update:5,all:8}, n7:{new:0,addon:0,update:1,all:1},
    np7:{new:1,addon:0,update:3,all:5}, openp7:111,
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    a100:{new:13,addon:5,update:7,all:28}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:2,addon:0,update:2,all:4}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:1,addon:2,update:0,all:4}, openp7:87,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:37,addon:8,update:4,all:73}, a30:{new:37,addon:8,update:4,all:69},
    a100:{new:15,addon:3,update:1,all:29}, cl7:{new:0,addon:0,update:2,all:3},
    cp7:{new:6,addon:2,update:3,all:12}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:0,update:0,all:1}, openp7:75,
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:{new:16,addon:16,update:26,all:63}, a30:{new:14,addon:7,update:6,all:32},
    a100:{new:3,addon:3,update:2,all:13}, cl7:{new:1,addon:1,update:6,all:8},
    cp7:{new:1,addon:1,update:1,all:3}, n7:{new:0,addon:4,update:12,all:16},
    np7:{new:0,addon:0,update:3,all:3}, openp7:55,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:29,update:23,all:68}, a30:{new:12,addon:28,update:18,all:59},
    a100:{new:7,addon:10,update:7,all:25}, cl7:{new:0,addon:2,update:4,all:7},
    cp7:{new:0,addon:0,update:1,all:2}, n7:{new:0,addon:0,update:1,all:2},
    np7:{new:0,addon:0,update:1,all:3}, openp7:73,
  ...
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:7,addon:9,update:45,all:68}, a30:{new:4,addon:6,update:19,all:36},
    a100:{new:0,addon:0,update:0,all:0}, cl7:{new:3,addon:3,update:2,all:8},
    cp7:{new:0,addon:1,update:3,all:4}, n7:{new:0,addon:1,update:13,all:14},
    np7:{new:0,addon:2,update:13,all:15}, openp7:62,
  ...
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:11,addon:16,update:2,all:49}, a30:{new:9,addon:11,update:2,all:25},
    a100:{new:4,addon:1,update:0,all:5}, cl7:{new:1,addon:0,update:0,all:1},
    cp7:{new:3,addon:8,update:1,all:21}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:3,update:0,all:19}, openp7:50,
    median:{new:45,addon:56,update:39,all:42}, medianAdj:{new:32,addon:52,update:15,all:33},
    medianTrend:[42,42,42,42,42] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:11,addon:18,update:16,all:50}, a30:{new:11,addon:18,update:16,all:50},
    a100:{new:9,addon:2,update:15,all:29}, cl7:{new:0,addon:2,update:0,all:3},
    cp7:{new:0,addon:2,update:0,all:2}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:53,
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    ...
    np7:{new:0,addon:0,update:0,all:10}, openp7:32,
