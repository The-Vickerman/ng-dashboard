...
const LAST_REFRESHED = "September 1, 2026 · 8:00 AM CT";
const AS_OF     = "September 1, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians from the Aug 24 delta-merged recompute (Jan 1 2026+ full census, null-reason excluded, consistent across all 11 analysts)";
const THIS_WEEK = "Aug 26–Sep 1";
const PREV_WEEK = "Aug 18–24";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:29,addon:63,update:19,all:114}, a30:{new:29,addon:56,update:7,all:93},
    a100:{new:25,addon:52,update:0,all:78}, cl7:{new:2,addon:2,update:1,all:5},
    cp7:{new:2,addon:2,update:1,all:5}, n7:{new:0,addon:0,update:2,all:3},
    np7:{new:0,addon:0,update:2,all:5}, openp7:116,
    median:{new:67,addon:62,update:24,all:34}, medianAdj:{new:46,addon:34,update:23,all:29},
    medianTrend:[34,34,34,34,34] },
  { name:"Daisy Marquez", region:"Americas",
    open:{new:14,addon:8,update:19,all:50}, a30:{new:14,addon:8,update:19,all:50},
    a100:{new:13,addon:8,update:19,all:48}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:51,
    median:{new:93,addon:52,update:137,all:94}, medianAdj:{new:46,addon:52,update:137,all:74},
    medianTrend:[93,93,94,94,94] },
  { name:"Jevon Jackson", region:"Americas",
    open:{new:32,addon:23,update:7,all:66}, a30:{new:31,addon:22,update:5,all:61},
    a100:{new:12,addon:10,update:5,all:30}, cl7:{new:3,addon:2,update:3,all:8},
    cp7:{new:3,addon:2,update:3,all:8}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:0,addon:0,update:2,all:2}, openp7:72,
    median:{new:66,addon:48,update:41,all:46}, medianAdj:{new:44,addon:33,update:29,all:34},
    medianTrend:[46,46,46,46,46] },
  { name:"Kristen Whitman", region:"Americas",
    open:{new:2,addon:4,update:4,all:11}, a30:{new:2,addon:1,update:4,all:7},
    a100:{new:1,addon:1,update:2,all:4}, cl7:{new:1,addon:0,update:0,all:4},
    cp7:{new:1,addon:0,update:0,all:3}, n7:{new:0,addon:1,update:0,all:3},
    np7:{new:0,addon:0,update:0,all:2}, openp7:12,
    median:{new:45,addon:56,update:17,all:45}, medianAdj:{new:30,addon:56,update:17,all:34},
    medianTrend:[45,45,45,45,45] },
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:37,addon:7,update:3,all:71}, a30:{new:37,addon:7,update:3,all:71},
    a100:{new:17,addon:4,update:2,all:33}, cl7:{new:0,addon:1,update:0,all:1},
    cp7:{new:0,addon:1,update:0,all:1}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:72,
    median:{new:89,addon:58,update:53,all:68}, medianAdj:{new:89,addon:35,update:53,all:63},
    medianTrend:[68,68,68,68,68] },
  { name:"Mariana Freitas", region:"Americas",
    open:{new:15,addon:14,update:19,all:53}, a30:{new:13,addon:11,update:10,all:39},
    a100:{new:7,addon:3,update:2,all:17}, cl7:{new:2,addon:2,update:3,all:7},
    cp7:{new:2,addon:2,update:3,all:7}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:60,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:29,update:20,all:65}, a30:{new:13,addon:24,update:17,all:56},
    a100:{new:9,addon:15,update:10,all:35}, cl7:{new:0,addon:1,update:0,all:1},
    cp7:{new:0,addon:1,update:0,all:1}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:0,update:0,all:1}, openp7:65,
    median:{new:84,addon:62,update:27,all:47}, medianAdj:{new:80,addon:48,update:26,all:29},
    medianTrend:[48,47,47,47,47] },
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:3,addon:14,update:43,all:67}, a30:{new:3,addon:5,update:21,all:36},
    a100:{new:1,addon:0,update:0,all:1}, cl7:{new:3,addon:1,update:6,all:10},
    cp7:{new:5,addon:0,update:6,all:11}, n7:{new:0,addon:0,update:1,all:1},
    np7:{new:0,addon:0,update:1,all:1}, openp7:76,
    median:{new:52,addon:41,update:36,all:38}, medianAdj:{new:46,addon:40,update:30,all:36},
    medianTrend:[40,38,38,38,38] },
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:9,addon:20,update:3,all:52}, a30:{new:7,addon:16,update:2,all:32},
    a100:{new:2,addon:2,update:0,all:4}, cl7:{new:2,addon:0,update:0,all:3},
    cp7:{new:2,addon:0,update:0,all:3}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:0,update:0,all:1}, openp7:54,
    median:{new:54,addon:100,update:44,all:50}, medianAdj:{new:42,addon:78,update:30,all:44},
    medianTrend:[51,50,50,50,50] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:10,addon:12,update:15,all:43}, a30:{new:10,addon:11,update:15,all:41},
    a100:{new:9,addon:1,update:14,all:27}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:0,update:0,all:1}, openp7:43,
    median:{new:160,addon:65,update:1,all:72}, medianAdj:{new:109,addon:54,update:1,all:62},
    medianTrend:[72,72,72,72,72] },
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:12,addon:18,update:1,all:45}, a30:{new:8,addon:14,update:1,all:24},
    a100:{new:3,addon:3,update:1,all:7}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:45,
    median:{new:0,addon:70,update:18,all:34}, medianAdj:{new:0,addon:62,update:18,all:34},
    medianTrend:[28,34,34,34,34] },
];
