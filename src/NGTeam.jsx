...
const AS_OF     = "July 6, 2026 — Live from Salesforce (open/aged/closed/new); medians as of Jun 28";
const THIS_WEEK = "Jun 30–Jul 6";
const PREV_WEEK = "Jun 23–29";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:35,addon:63,update:37,all:139}, a30:{new:32,addon:61,update:6,all:101},
    a100:{new:1,addon:4,update:1,all:6}, cl7:{new:4,addon:2,update:16,all:28},
    cp7:{new:4,addon:4,update:9,all:30}, n7:{new:0,addon:0,update:5,all:5},
    np7:{new:0,addon:0,update:8,all:8}, openp7:132,
  ...
  { name:"Jevon Jackson", region:"Americas",
    open:{new:23,addon:17,update:23,all:66}, a30:{new:23,addon:17,update:23,all:66},
    a100:{new:11,addon:5,update:3,all:22}, cl7:{new:1,addon:2,update:3,all:6},
    cp7:{new:6,addon:5,update:3,all:14}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:67,
  ...
  { name:"Kristen Whitman", region:"Americas",
    open:{new:6,addon:15,update:5,all:26}, a30:{new:6,addon:15,update:4,all:25},
    a100:{new:1,addon:4,update:2,all:7}, cl7:{new:6,addon:0,update:1,all:7},
    cp7:{new:0,addon:0,update:2,all:2}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:31,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:60,addon:11,update:11,all:101}, a30:{new:40,addon:3,update:8,all:62},
    a100:{new:6,addon:2,update:1,all:19}, cl7:{new:3,addon:2,update:2,all:19},
    cp7:{new:2,addon:2,update:0,all:4}, n7:{new:0,addon:0,update:0,all:4},
    np7:{new:16,addon:1,update:0,all:19}, openp7:99,
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:{new:15,addon:10,update:14,all:45}, a30:{new:11,addon:6,update:13,all:36},
    a100:{new:3,addon:3,update:0,all:6}, cl7:{new:1,addon:4,update:6,all:12},
    cp7:{new:7,addon:4,update:9,all:20}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:2,addon:0,update:0,all:2}, openp7:55,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:12,addon:21,update:27,all:63}, a30:{new:12,addon:20,update:22,all:57},
    a100:{new:2,addon:3,update:7,all:13}, cl7:{new:2,addon:0,update:1,all:3},
    cp7:{new:2,addon:9,update:5,all:18}, n7:{new:0,addon:0,update:2,all:2},
  ...
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:7,addon:7,update:8,all:30}, a30:{new:4,addon:5,update:7,all:17},
    a100:{new:4,addon:2,update:0,all:6}, cl7:{new:0,addon:0,update:2,all:2},
    cp7:{new:1,addon:0,update:1,all:2}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:2,addon:0,update:0,all:9}, openp7:30,
  ...
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:14,addon:14,update:7,all:51}, a30:{new:11,addon:13,update:3,all:43},
    a100:{new:8,addon:9,update:0,all:31}, cl7:{new:0,addon:1,update:0,all:3},
    cp7:{new:0,addon:0,update:0,all:1}, n7:{new:0,addon:0,update:1,all:2},
  ...
  { name:"Oleksii Kosenko", region:"EU",
    ...
    a100:{new:5,addon:2,update:11,all:22}, cl7:{new:0,addon:1,update:0,all:2},
    cp7:{new:1,addon:1,update:0,all:3}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:2,update:1,all:3}, openp7:58,
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:6,addon:10,update:1,all:24}, a30:{new:5,addon:4,update:1,all:17},
    a100:{new:4,addon:3,update:0,all:12}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:1,update:0,all:8}, n7:{new:0,addon:1,update:0,all:1},
    np7:{new:1,addon:5,update:0,all:6}, openp7:23,
