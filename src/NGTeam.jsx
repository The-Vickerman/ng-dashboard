...
const LAST_REFRESHED = "July 31, 2026 · 12:05 PM CT";
const AS_OF     = "July 31, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians as of Jul 16 recompute (Jan 1, 2026+ closed-case census, null-reason excluded)";
const THIS_WEEK = "Jul 25–31";
const PREV_WEEK = "Jul 23–29";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    ...
    cp7:{new:1,addon:0,update:5,all:7}, n7:{new:0,addon:0,update:1,all:4},
    np7:{new:0,addon:0,update:0,all:2}, openp7:110,
    median:{new:76,addon:62,update:22,all:32}, medianAdj:{new:40,addon:34,update:22,all:27},
    medianTrend:[64,26,32,32,32] },
  { name:"Daisy Marquez", region:"Americas",
    ...
    medianTrend:[null,null,93,93,93] },
  { name:"Jevon Jackson", region:"Americas",
    ...
    cp7:{new:1,addon:0,update:1,all:2}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:21,addon:4,update:0,all:25}, openp7:86,
    median:{new:43,addon:48,update:41,all:42}, medianAdj:{new:28,addon:33,update:29,all:29},
    medianTrend:[71,74,42,42,42] },
  { name:"Kristen Whitman", region:"Americas",
    ...
    cp7:{new:1,addon:1,update:0,all:2}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:1,addon:0,update:1,all:2}, openp7:16,
    median:{new:42,addon:45,update:17,all:42}, medianAdj:{new:28,addon:45,update:17,all:28},
    medianTrend:[36,328,42,42,42] },
  ...
  { name:"Mariana Freitas", region:"Americas",
    ...
    cp7:{new:0,addon:2,update:2,all:4}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:2,addon:1,update:2,all:5}, openp7:56,
    median:{new:50,addon:44,update:32,all:40}, medianAdj:{new:34,addon:35,update:31,all:34},
    medianTrend:[68,66,40,40,40] },
  { name:"Nia Gillenwater", region:"Americas",
    ...
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:3,all:3},
    np7:{new:0,addon:1,update:2,all:6}, openp7:71,
    median:{new:84,addon:61,update:26,all:47}, medianAdj:{new:80,addon:43,update:24,all:28},
    medianTrend:[67,null,47,47,47] },
  { name:"Fabrizio Ramirez", region:"Americas",
    ...
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:4,all:4},
    np7:{new:0,addon:0,update:2,all:2}, openp7:60,
    median:{new:35,addon:0,update:31,all:34}, medianAdj:{new:15,addon:0,update:28,all:28},
    medianTrend:[40,32,34,34,34] },
  { name:"Nathalie Lesmes", region:"EU",
    ...
    cp7:{new:2,addon:1,update:0,all:3}, n7:{new:0,addon:3,update:0,all:20},
    np7:{new:2,addon:0,update:0,all:3}, openp7:35,
    median:{new:45,addon:56,update:39,all:42}, medianAdj:{new:32,addon:52,update:15,all:33},
    medianTrend:[88,null,42,42,42] },
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    ...
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:6},
    np7:{new:0,addon:0,update:0,all:1}, openp7:27,
    median:{new:0,addon:99,update:0,all:99}, medianAdj:{new:0,addon:84,update:0,all:84},
    medianTrend:[null,null,99,99,99] },
];
