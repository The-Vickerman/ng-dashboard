...
const LAST_REFRESHED = "August 24, 2026 · 12:10 PM CT";
const AS_OF     = "August 24, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians from the Aug 24 delta-merged recompute (Jan 1 2026+ full census, null-reason excluded, consistent across all 11 analysts)";
const THIS_WEEK = "Aug 18–24";
const PREV_WEEK = "Aug 11–17";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:30,addon:63,update:22,all:120}, a30:{new:30,addon:56,update:9,all:96},
    a100:{new:25,addon:52,update:0,all:78}, cl7:{new:2,addon:2,update:1,all:5},
    cp7:{new:0,addon:1,update:4,all:5}, n7:{new:0,addon:0,update:2,all:5},
    np7:{new:0,addon:0,update:6,all:6}, openp7:120,
  ...
  { name:"Daisy Marquez", region:"Americas",
    ...
    medianTrend:[93,93,93,94,94] },
  { name:"Jevon Jackson", region:"Americas",
    open:{new:35,addon:25,update:8,all:72}, a30:{new:34,addon:24,update:6,all:67},
    a100:{new:14,addon:11,update:6,all:34}, cl7:{new:3,addon:2,update:3,all:8},
    cp7:{new:4,addon:3,update:1,all:8}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:0,addon:0,update:0,all:0}, openp7:78,
    median:{new:66,addon:48,update:41,all:46}, medianAdj:{new:44,addon:33,update:29,all:34},
    medianTrend:[42,46,46,46,46] },
  { name:"Kristen Whitman", region:"Americas",
    open:{new:2,addon:3,update:4,all:11}, a30:{new:2,addon:1,update:4,all:7},
    a100:{new:1,addon:1,update:2,all:4}, cl7:{new:1,addon:0,update:0,all:3},
    cp7:{new:0,addon:1,update:0,all:2}, n7:{new:0,addon:0,update:0,all:2},
    np7:{new:0,addon:2,update:0,all:5}, openp7:12,
    median:{new:45,addon:56,update:17,all:45}, medianAdj:{new:30,addon:56,update:17,all:34},
    medianTrend:[42,45,45,45,45] },
  ...
  { name:"Mariana Freitas", region:"Americas",
    ...
    cp7:{new:1,addon:0,update:2,all:3}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:1,all:1}, openp7:60,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:29,update:21,all:67}, a30:{new:13,addon:24,update:17,all:56},
    a100:{new:9,addon:15,update:10,all:35}, cl7:{new:0,addon:1,update:0,all:1},
    cp7:{new:0,addon:2,update:5,all:9}, n7:{new:0,addon:0,update:0,all:1},
    np7:{new:0,addon:4,update:2,all:7}, openp7:67,
    median:{new:84,addon:62,update:27,all:47}, medianAdj:{new:80,addon:48,update:26,all:29},
    medianTrend:[47,48,48,47,47] },
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:3,addon:15,update:43,all:68}, a30:{new:3,addon:6,update:21,all:37},
    a100:{new:1,addon:0,update:0,all:1}, cl7:{new:5,addon:0,update:6,all:11},
    cp7:{new:0,addon:1,update:3,all:4}, n7:{new:0,addon:0,update:1,all:1},
    np7:{new:0,addon:0,update:1,all:1}, openp7:78,
    median:{new:52,addon:41,update:36,all:38}, medianAdj:{new:46,addon:40,update:30,all:36},
    medianTrend:[34,40,40,38,38] },
  { name:"Nathalie Lesmes", region:"EU",
    ...
    np7:{new:1,addon:1,update:1,all:3}, openp7:54,
    median:{new:54,addon:100,update:44,all:50}, medianAdj:{new:42,addon:78,update:30,all:44},
    medianTrend:[42,51,51,50,50] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:10,addon:11,update:15,all:42}, a30:{new:10,addon:11,update:15,all:41},
