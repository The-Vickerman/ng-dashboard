...
const LAST_REFRESHED = "August 14, 2026 · 3:15 PM CT";
const AS_OF     = "August 14, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians freshly and fully recomputed Aug 14 — all 11 analysts on the SAME full Jan 1 2026+ closed-case census methodology, null-reason excluded. No mixed windows.";
