...
const AS_OF     = "August 14, 2026 — Live from Salesforce (open/aged/closed/new, trailing 7d); medians freshly recomputed Aug 14 — 7 analysts (Prathiba, Daisy, Oleksii, Fabrizio, Kristen, Nathalie, Kristina) use full Jan 1 2026+ closed-case census; 4 analysts (Nia, Mariana, Jevon, Aline — high volume) use trailing-90-day-closed census instead, for feasibility. Null-reason cases excluded throughout.";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    ...
    median:{new:81,addon:72,update:24,all:40}, medianAdj:{new:49,addon:38,update:24,all:33},
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    median:{new:86,addon:58,update:48,all:63}, medianAdj:{new:70,addon:33,update:46,all:50},
  ...
  { name:"Mariana Freitas", region:"Americas",
    ...
    median:{new:65,addon:64,update:34,all:46}, medianAdj:{new:54,addon:58,update:32,all:41},
  ...
  { name:"Nia Gillenwater", region:"Americas",
    ...
    median:{new:91,addon:80,update:46,all:64}, medianAdj:{new:64,addon:71,update:38,all:49},
