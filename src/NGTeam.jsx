...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:{new:33,addon:57,update:19,all:114}, a30:{new:28,addon:54,update:17,all:100},
    a100:{new:24,addon:49,update:1,all:74}, cl7:{new:1,addon:0,update:5,all:7},
    cp7:{new:1,addon:1,update:7,all:10}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:2}, openp7:121,
    median:{new:76,addon:62,update:22,all:32}, medianAdj:{new:40,addon:34,update:22,all:27},
    medianTrend:[60,64,26,32,32] },
  { name:"Daisy Marquez", region:"Americas",
    open:{new:12,addon:8,update:21,all:50}, a30:{new:12,addon:8,update:21,all:50},
    ...
    medianTrend:[null,null,null,93,93] },
  { name:"Jevon Jackson", region:"Americas",
    open:{new:43,addon:27,update:14,all:87}, a30:{new:20,addon:12,update:14,all:49},
    a100:{new:14,addon:4,update:7,all:28}, cl7:{new:1,addon:0,update:1,all:2},
    cp7:{new:1,addon:3,update:6,all:10}, n7:{new:0,addon:1,update:0,all:1},
    np7:{new:21,addon:4,update:0,all:25}, openp7:88,
    median:{new:43,addon:48,update:41,all:42}, medianAdj:{new:28,addon:33,update:29,all:29},
    medianTrend:[45,71,74,42,42] },
  { name:"Kristen Whitman", region:"Americas",
    open:{new:2,addon:3,update:4,all:9}, a30:{new:1,addon:3,update:2,all:6},
    a100:{new:0,addon:1,update:1,all:2}, cl7:{new:1,addon:1,update:0,all:2},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:2,all:2},
    np7:{new:1,addon:0,update:1,all:2}, openp7:9,
    median:{new:42,addon:45,update:17,all:42}, medianAdj:{new:28,addon:45,update:17,all:28},
    medianTrend:[85,36,328,42,42] },
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:51,addon:10,update:9,all:91}, a30:{new:50,addon:10,update:7,all:83},
    a100:{new:5,addon:2,update:0,all:17}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:0,update:2,all:5}, n7:{new:0,addon:0,update:1,all:1},
    np7:{new:1,addon:0,update:0,all:3}, openp7:90,
    median:{new:63,addon:58,update:50,all:62}, medianAdj:{new:63,addon:28,update:50,all:56},
    medianTrend:[64,110,91,62,62] },
  { name:"Mariana Freitas", region:"Americas",
    open:{new:18,addon:14,update:23,all:60}, a30:{new:15,addon:8,update:7,all:35},
    a100:{new:2,addon:2,update:3,all:12}, cl7:{new:0,addon:2,update:2,all:4},
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:0,addon:0,update:6,all:6},
    np7:{new:2,addon:1,update:0,all:3}, openp7:58,
    median:{new:50,addon:44,update:32,all:40}, medianAdj:{new:34,addon:35,update:31,all:34},
    medianTrend:[81,68,66,40,40] },
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:13,addon:30,update:26,all:70}, a30:{new:10,addon:26,update:21,all:58},
    a100:{new:2,addon:10,update:7,all:20}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:1,addon:1,update:1,all:5}, n7:{new:0,addon:0,update:1,all:2},
    np7:{new:1,addon:1,update:2,all:7}, openp7:69,
    median:{new:84,addon:61,update:26,all:47}, medianAdj:{new:80,addon:43,update:24,all:28},
    medianTrend:[59,67,null,47,47] },
  { name:"Fabrizio Ramirez", region:"Americas",
    open:{new:8,addon:7,update:33,all:55}, a30:{new:6,addon:7,update:9,all:29},
    a100:{new:0,addon:0,update:0,all:0}, cl7:{new:0,addon:0,update:1,all:1},
    cp7:{new:1,addon:1,update:0,all:2}, n7:{new:2,addon:0,update:1,all:3},
    np7:{new:0,addon:0,update:2,all:2}, openp7:53,
    median:{new:35,addon:0,update:31,all:34}, medianAdj:{new:15,addon:0,update:28,all:28},
    medianTrend:[null,40,32,34,34] },
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:14,addon:21,update:3,all:50}, a30:{new:11,addon:19,update:3,all:42},
    a100:{new:7,addon:8,update:1,all:24}, cl7:{new:2,addon:1,update:0,all:3},
    cp7:{new:0,addon:0,update:0,all:3}, n7:{new:1,addon:1,update:0,all:3},
    np7:{new:1,addon:0,update:0,all:2}, openp7:50,
    median:{new:45,addon:56,update:39,all:42}, medianAdj:{new:32,addon:52,update:15,all:33},
    medianTrend:[50,88,null,42,42] },
  { name:"Oleksii Kosenko", region:"EU",
    open:{new:11,addon:21,update:16,all:54}, a30:{new:11,addon:21,update:16,all:54},
    a100:{new:8,addon:2,update:13,all:27}, cl7:{new:0,addon:0,update:0,all:1},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:1,all:1}, openp7:55,
    median:{new:160,addon:31,update:1,all:76}, medianAdj:{new:109,addon:30,update:1,all:60},
    medianTrend:[222,null,138,76,76] },
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:7,addon:12,update:3,all:28}, a30:{new:7,addon:11,update:1,all:25},
    a100:{new:4,addon:3,update:0,all:12}, cl7:{new:0,addon:0,update:0,all:0},
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:1}, openp7:28,
    median:{new:0,addon:99,update:0,all:99}, medianAdj:{new:0,addon:84,update:0,all:84},
    medianTrend:[null,null,null,99,99] },
];
