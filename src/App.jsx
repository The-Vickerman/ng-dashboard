...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    ...
    a100:{new:0,addon:5,update:1,all:6}, cl7:{new:4,addon:4,update:9,all:30},
    cp7:{new:3,addon:16,update:1,all:24}, n7:{new:0,addon:0,update:8,all:8},
    np7:{new:1,addon:0,update:1,all:4}, openp7:154,
  ...
  { name:"Daisy Marquez", region:"Americas",
    open:{new:16,addon:9,update:22,all:55}, a30:{new:15,addon:9,update:22,all:52},
    a100:{new:12,addon:5,update:22,all:45}, cl7:{new:0,addon:0,update:0,all:0},
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    cp7:{new:2,addon:2,update:2,all:6}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:81,
  ...
  { name:"Kristen Whitman", region:"Americas",
    open:{new:13,addon:14,update:4,all:31}, a30:{new:13,addon:9,update:3,all:25},
    a100:{new:0,addon:3,update:1,all:4}, cl7:{new:0,addon:0,update:2,all:2},
    cp7:{new:1,addon:2,update:2,all:6}, n7:{new:0,addon:0,update:0,all:0},
    np7:{new:0,addon:0,update:0,all:0}, openp7:33,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:{new:62,addon:8,update:13,all:99}, a30:{new:40,addon:5,update:10,all:66},
    a100:{new:8,addon:4,update:2,all:24}, cl7:{new:2,addon:2,update:0,all:4},
    cp7:{new:1,addon:2,update:1,all:12}, n7:{new:16,addon:1,update:0,all:19},
    np7:{new:3,addon:0,update:1,all:5}, openp7:84,
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:{new:14,addon:12,update:22,all:55}, a30:{new:12,addon:10,update:18,all:47},
    a100:{new:3,addon:5,update:1,all:9}, cl7:{new:7,addon:4,update:9,all:20},
    cp7:{new:2,addon:3,update:3,all:8}, n7:{new:2,addon:0,update:0,all:2},
    np7:{new:0,addon:0,update:1,all:1}, openp7:73,
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:{new:15,addon:23,update:25,all:65}, a30:{new:14,addon:20,update:20,all:56},
    a100:{new:4,addon:3,update:5,all:12}, cl7:{new:2,addon:9,update:5,all:18},
  ...
  { name:"Fabrizio Ramirez", region:"Americas",
    ...
    cp7:{new:0,addon:0,update:1,all:1}, n7:{new:2,addon:0,update:0,all:9},
  ...
  { name:"Nathalie Lesmes", region:"EU",
    open:{new:14,addon:14,update:6,all:50}, a30:{new:10,addon:12,update:2,all:40},
    a100:{new:5,addon:9,update:0,all:28}, cl7:{new:0,addon:0,update:0,all:1},
  ...
  { name:"Oleksii Kosenko", region:"EU",
    ...
    cp7:{new:0,addon:0,update:0,all:0}, n7:{new:0,addon:2,update:1,all:3},
    np7:{new:0,addon:0,update:0,all:0}, openp7:58,
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    open:{new:6,addon:8,update:1,all:23}, a30:{new:5,addon:3,update:1,all:16},
    a100:{new:4,addon:3,update:0,all:11}, cl7:{new:0,addon:1,update:0,all:8},
