...
const AS_OF     = "June 18, 2026 — Live from Salesforce";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:  {new:36,addon:68,update:7,all:126},
    a30:   {new:33,addon:65,update:5,all:104},
    a100:  {new:0,addon:6,update:0,all:6},
    cl7:   {new:2,addon:5,update:1,all:12},
    cp7:   {new:6,addon:1,update:3,all:13},
    n7:    {new:0,addon:1,update:0,all:2},
    np7:   {new:1,addon:2,update:2,all:9},
    openp7:136,
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    a30:   {new:21,addon:12,update:22,all:58},
  ...
  { name:"Kristen Whitman", region:"Americas",
    open:  {new:15,addon:14,update:5,all:34},
    a30:   {new:5,addon:4,update:4,all:13},
    a100:  {new:0,addon:2,update:1,all:3},
    cl7:   {new:0,addon:2,update:0,all:2},
    cp7:   {new:0,addon:0,update:0,all:1},
    n7:    {new:0,addon:0,update:0,all:1},
    np7:   {new:0,addon:5,update:1,all:7},
    openp7:35,
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:  {new:27,addon:7,update:10,all:60},
    a30:   {new:22,addon:6,update:7,all:47},
    a100:  {new:6,addon:3,update:2,all:22},
    cl7:   {new:0,addon:0,update:2,all:9},
    cp7:   {new:1,addon:0,update:1,all:24},
    n7:    {new:1,addon:1,update:2,all:8},
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:  {new:16,addon:14,update:24,all:61},
    a30:   {new:12,addon:8,update:12,all:39},
    a100:  {new:2,addon:5,update:1,all:8},
    cl7:   {new:1,addon:2,update:5,all:8},
    cp7:   {new:2,addon:2,update:0,all:5},
    n7:    {new:0,addon:2,update:2,all:4},
    np7:   {new:0,addon:0,update:1,all:1},
    openp7:65,
  ...
  { name:"Nathalie Lesmes Rodriguez", region:"EU",
    open:  {new:13,addon:14,update:6,all:50},
    ...
    n7:    {new:2,addon:0,update:1,all:4},
    np7:   {new:1,addon:2,update:1,all:5},
    openp7:53,
    median:   {new:74,addon:121,update:55,all:70},
    medianAdj:{new:52,addon:84,update:39,all:49},
    mNote:{new:false,addon:false,update:false,all:false}},
  { name:"Oleksii Kosenko", region:"EU",
    open:  {new:10,addon:23,update:15,all:57},
    a30:   {new:8,addon:2,update:15,all:31},
    a100:  {new:6,addon:2,update:9,all:18},
    cl7:   {new:0,addon:0,update:0,all:0},
    cp7:   {new:0,addon:0,update:0,all:1},
    n7:    {new:0,addon:0,update:0,all:0},
    np7:   {new:1,addon:4,update:0,all:5},
    openp7:57,
  ...
  { name:"Prathiba Seetharaman", region:"EU",
    open:  {new:5,addon:3,update:1,all:24},
    a30:   {new:5,addon:3,update:1,all:23},
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:  {new:36,addon:69,update:8,all:129},
    a30:   {new:33,addon:66,update:6,all:106},
  ...
  { name:"Jevon Jackson", region:"Americas",
    open:  {new:28,addon:23,update:27,all:81},
    a30:   {new:21,addon:12,update:19,all:55},
    a100:  {new:11,addon:6,update:3,all:23},
    cl7:   {new:0,addon:1,update:2,all:3},
    cp7:   {new:1,addon:0,update:2,all:4},
    n7:    {new:0,addon:0,update:0,all:0},
  ...
  { name:"Kristen Whitman", region:"Americas",
    ...
    mNote:{new:false,addon:false,update:false,all:false}},
  { name:"Kristina Quirouette", region:"Americas",
    open:  {new:28,addon:8,update:10,all:64},
    a30:   {new:23,addon:7,update:7,all:51},
    a100:  {new:7,addon:4,update:2,all:24},
    cl7:   {new:0,addon:0,update:2,all:9},
    cp7:   {new:1,addon:0,update:1,all:24},
    n7:    {new:1,addon:1,update:2,all:8},
    np7:   {new:0,addon:0,update:0,all:0},
    ...
    mNote:{new:false,addon:false,update:false,all:false}},
  { name:"Mariana Freitas", region:"Americas",
    open:  {new:17,addon:15,update:24,all:63},
    a30:   {new:13,addon:9,update:12,all:41},
    a100:  {new:2,addon:5,update:1,all:8},
    cl7:   {new:1,addon:2,update:5,all:8},
    cp7:   {new:2,addon:2,update:0,all:5},
    n7:    {new:0,addon:2,update:2,all:4},
    ...
    mNote:{new:false,addon:false,update:false,all:false}},
  { name:"Nia Gillenwater", region:"Americas",
    open:  {new:17,addon:25,update:26,all:73},
    a30:   {new:14,addon:19,update:18,all:53},
    a100:  {new:4,addon:3,update:3,all:10},
    cl7:   {new:0,addon:1,update:2,all:5},
    cp7:   {new:0,addon:1,update:7,all:8},
    n7:    {new:0,addon:1,update:0,all:5},
    ...
    mNote:{new:false,addon:false,update:false,all:false}},
  { name:"Fabrizio Ramires", region:"Americas",
    open:  {new:4,addon:3,update:7,all:21},
    a30:   {new:3,addon:1,update:2,all:6},
    a100:  {new:0,addon:1,update:0,all:1},
    cl7:   {new:0,addon:0,update:0,all:0},
    cp7:   {new:0,addon:0,update:1,all:1},
    ...
    mNote:{new:true,addon:true,update:true,all:true}},
  { name:"Nathalie Lesmes Rodriguez", region:"EU",
    open:  {new:13,addon:14,update:5,all:49},
    a30:   {new:10,addon:11,update:2,all:38},
    a100:  {new:5,addon:9,update:0,all:20},
    cl7:   {new:2,addon:3,update:1,all:7},
    cp7:   {new:0,addon:0,update:1,all:2},
