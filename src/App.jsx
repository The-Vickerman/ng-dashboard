...
const TEAM = [
  ...
  { name:"Daisy Marquez", region:"Americas",
    ...
    medianAdj:{new:160, addon:162, update:148,all:158},
  ...
  { name:"Jevon Jackson", region:"Americas",
    ...
    medianAdj:{new:42,  addon:36,  update:27, all:32 },
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Kristen Whitman", region:"Americas",
    ...
    medianAdj:{new:64,  addon:63,  update:28, all:58 },
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Kristina Quirouette", region:"Americas",
    ...
    medianAdj:{new:94,  addon:51,  update:54, all:61 },
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Mariana Freitas", region:"Americas",
    ...
    medianAdj:{new:52,  addon:39,  update:23, all:38 },
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Nia Gillenwater", region:"Americas",
    ...
    medianAdj:{new:56,  addon:35,  update:33, all:38 },
    mNote:{new:false,addon:false,update:false,all:false} },
  ...
  { name:"Nathalie Lesmes Rodriguez", region:"EU",
    ...
    medianAdj:{new:52,  addon:84,  update:39, all:61 },
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Oleksii Kosenko", region:"EU",
    ...
    medianAdj:{new:128, addon:119, update:94, all:118},
    mNote:{new:false,addon:false,update:false,all:false} },
  { name:"Prathiba Seetharaman", region:"EU",
    ...
    medianAdj:{new:null,addon:null,update:null,all:null},
    mNote:{new:true,addon:true,update:true,all:true} },
];
...
export default function App(){
  ...
  const[adjMode,setAdjMode]=useState(false);  // false=raw, true=adjusted
  ...
  const TOOLTIP_ADJ = "Adjusted: excludes days spent in:\n• On Hold\n• FourKites Working\n• Awaiting Loads\n\nThese statuses are outside the analyst's control. Adjusted median reflects true analyst-controlled cycle time.";
