...
const AS_OF     = "June 22, 2026 — Live from Salesforce";
...
const TEAM = [
  { name:"Aline Ventura", region:"Americas",
    open:  {new:36,addon:66,update:7,all:129},
    a30:   {new:32,addon:63,update:5,all:101},
    a100:  {new:0,addon:6,update:0,all:6},
    cl7:   {new:1,addon:13,update:2,all:19},
  ...
  { name:"Jevon Jackson", region:"Americas",
    open:  {new:28,addon:22,update:28,all:81},
    a30:   {new:28,addon:22,update:24,all:77},
  ...
  { name:"Kristen Whitman", region:"Americas",
    open:  {new:14,addon:14,update:5,all:33},
    a30:   {new:14,addon:9,update:4,all:27},
    a100:  {new:0,addon:2,update:1,all:3},
    cl7:   {new:1,addon:1,update:2,all:5},
  ...
  { name:"Kristina Quirouette", region:"Americas",
    open:  {new:27,addon:7,update:11,all:60},
    a30:   {new:23,addon:6,update:8,all:48},
  ...
  { name:"Mariana Freitas", region:"Americas",
    open:  {new:16,addon:13,update:24,all:60},
    a30:   {new:16,addon:11,update:14,all:48},
  ...
  { name:"Nia Gillenwater", region:"Americas",
    open:  {new:16,addon:23,update:25,all:68},
    a30:   {new:15,addon:20,update:20,all:58},
    a100:  {new:4,addon:3,update:4,all:11},
    cl7:   {new:2,addon:2,update:1,all:6},
  ...
  { name:"Fabrizio Ramires", region:"Americas",
    open:  {new:5,addon:4,update:7,all:17},
    a30:   {new:3,addon:3,update:3,all:9},
  ...
  { name:"Nathalie Lesmes Rodriguez", region:"EU",
    ...
    a100:  {new:5,addon:9,update:0,all:25},
